# Contributing to sleep-cde-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
sleep-cde-schema. These guidelines are not strict rules.
...
The sleep-cde-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the sleep-cde-schema technical leads
...
[issues]: https://github.com/diatomsRcool/sleep-cde-schema/issues/
[pulls]: https://github.com/diatomsRcool/sleep-cde-schema/pulls/
